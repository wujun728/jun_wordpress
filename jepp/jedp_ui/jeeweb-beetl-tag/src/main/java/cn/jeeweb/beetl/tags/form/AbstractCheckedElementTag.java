...
public abstract class AbstractCheckedElementTag extends AbstractHtmlInputElementTag {
	 ...
	 * through delegating to {@link cn.jeeweb.beetl.tags.form.SelectedValueComparator#isSelected}.
	 */
	private boolean isOptionSelected(Object value) throws BeetlTagException {
		return cn.jeeweb.beetl.tags.form.SelectedValueComparator.isSelected(getBindStatus(), value);
	}
