 ...
 *
 */
//@Action(value = "noteAction", results = { @Result(name = "note", location = "/com/sys/base/note.jsp") })
@Controller
@RequestMapping("/NoteAction.do")
public class NoteAction extends BaseAction{
	...
	@Autowired
	public void setNoteService(NoteServiceI noteService) {
	...
	public void showDesc(Model model, HttpServletRequest request, HttpServletResponse response) {
		writeJson(response, noteService.get(notePage));
	}
	...
	public void datagrid(Model model, HttpServletRequest request, HttpServletResponse response) {
		writeJson(response, noteService.datagrid(notePage));
	}
	...
	public void  combox(Model model, HttpServletRequest request, HttpServletResponse response){
		writeJson(response, noteService.listAll(notePage));
	}
	...
	public void delete(Model model, HttpServletRequest request, HttpServletResponse response) {
		Json j = new Json();
		noteService.delete(notePage.getIds());
		j.setSuccess(true);
		writeJson(response, j);
	}
