...
import cn.jeeweb.bbs.security.shiro.utils.ShiroExt;
import cn.jeeweb.bbs.utils.PostsUtils;
import cn.jeeweb.bbs.utils.SignInUtils;
...
public class BeetlConfig {
    ...
    public BeetlGroupUtilConfiguration beetlConfig(@Qualifier("tagFactorys") Map<String, TagFactory> tagFactorys) {
        ...
        beetlGroupUtilConfiguration.getGroupTemplate().registerFunctionPackage("postsUtils",new PostsUtils());
        beetlGroupUtilConfiguration.getGroupTemplate().registerFunctionPackage("signInUtils",new SignInUtils());
        beetlGroupUtilConfiguration.getGroupTemplate().registerFunctionPackage("dictUtils",new DictUtils());
